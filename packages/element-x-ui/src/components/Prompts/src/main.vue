<template>
    <div :class="[
      ...
      rootClassName
        ...
        <!-- 标题 -->
        <h5 v-if="title" class="el-x-prompts-title" :class="[classNames.title]" :style="titleStyle">{{ title }}</h5>
          ...
          classNames.item
            ...
            classNames.itemContent
                    ...
                    <h6 v-if="info.label" class="el-x-prompts-label">
                        <slot name="label" :item="info">{{ info.label }}</slot>
                    </h6>

                    <!-- 描述 -->
                    <p v-if="info.description" class="el-x-prompts-desc">
                        <slot name="description" :item="info">{{ info.description }}</slot>
                    </p>
