    ...
    <div :class="containerClass" :style="styleConfig" class="el-x-welcome">
        ...
        <div class="content-wrapper">
            ...
            <div v-if="hasTitleOrExtra" class="title-wrapper">
                <div v-if="title" :class="titleClass" :style="styles && styles.title" class="el-x-welcome-title">{{ title }}</div>
                <div v-if="hasExtraOrSlot" :class="extraClass" :style="styles && styles.extra" class="el-x-welcome-extra">
                    <slot name="extra">{{ extra }}</slot>
                </div>
            </div>

            <!--  description -->
            <div v-if="hasDescription" :class="descriptionClass" :style="styles && styles.description" class="el-x-welcome-description">{{ description }}</div>
        </div>
    </div>
</template>
