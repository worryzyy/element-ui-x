        ...
        <button class="trigger" :class="[localStatus, { disabled: !disabled }]" :disabled="disabled" @click="changeExpand">
            <span class="status-icon">
                <slot name="status-icon" :status="localStatus">
                    ...
                    <i v-if="localStatus === 'start'" class="el-icon-center start-color el-icon-opportunity"></i>
                    <i v-if="localStatus === 'end'" class="el-icon-center end-color el-icon-success"></i>
                    <i v-if="localStatus === 'error'" class="el-icon-center error-color el-icon-circle-close"></i>
                </slot>
            </span>
...
export default {
    ...
    methods: {
        changeExpand() {
            ...
            this.$emit('change', { value: this.isExpanded, status: this.localStatus })
