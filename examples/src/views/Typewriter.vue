    ...
    <div>
        <el-card class="demo-card">
            ...
            <div class="demo-block">
                <h3>基础用法（控制文字打印）</h3>
                <el-x-typewriter :content="basicContent" :typing="basicTyping" ref="basicDemo" @start="onStart" @writing="onWriting" @finish="onFinish" @interrupt="onTerrupt" />
                <div class="demo-controls">
                    <el-button-group>
                        <el-button size="small" type="primary" @click="startBasic">预览</el-button>
                        <el-button size="small" v-if="isBasicTyping && progress < 100" @click="pauseBasic">暂停</el-button>
                        <el-button size="small" v-if="!isBasicTyping && progress < 100" @click="continueBasic">继续</el-button>
            ...
            <div class="demo-block">
                ...
                <div class="control-row">
                    <h4>打字速度：</h4>
                    <el-slider style="width: 200px;" v-model="typingConfig.interval" :min="10" :max="100" :step="5" :marks="{10: '快', 50: '中', 100: '慢'}" />
                </div>
                <el-x-typewriter :content="speedContent" :typing="{interval: typingConfig.interval, step: 1}" ref="speedDemo" />
                <div class="demo-controls">
            ...
            <div class="demo-block">
                <h3>雾化效果</h3>
                <el-x-typewriter :content="fogContent" :typing="true" :is-fog="fogConfig" ref="fogDemo" />
                <div class="control-row">
                    <h4>雾化宽度：</h4>
                    <el-slider style="width: 200px;" v-model="fogWidth" :min="50" :max="200" @change="updateFogConfig" />
                </div>
                <div class="control-row">
                    <h4>背景颜色：</h4>
                    <el-color-picker v-model="fogConfig.bgColor" @change="updateFogConfig" size="small" />
                </div>
                <div class="demo-controls">
            ...
            <div class="demo-block">
                <h3>Markdown渲染</h3>
                <el-x-typewriter :content="markdownContent" :is-fog="fogConfig" :is-markdown="true" :typing="{interval: 30, step: 1}" ref="markdownDemo" />
                <div class="demo-controls">
            ...
            <div class="demo-block">
                ...
                <div class="chat-container">
                    ...
                    <div class="message bot">
                        ...
                        <div class="content">
                            <el-x-typewriter :content="aiResponse" :is-fog="fogConfig" :typing="{interval: 30, step: 1,suffix:''}" ref="aiDemo" />
                        </div>
                    </div>
                </div>
                <div class="demo-controls">
                    <el-button type="primary" @click="regenerateAIResponse">重新生成回答</el-button>
                </div>
            </div>
        </el-card>
    </div>
