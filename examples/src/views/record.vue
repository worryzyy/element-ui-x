  ...
  <div>
    <el-card class="demo-card">
      ...
      <div class="demo-block">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-button type="primary" :disabled="recordLoading" @click="beginRecord">
              开始录音
            </el-button>
          </el-col>
          <el-col :span="12">
            <el-button type="danger" :disabled="!recordLoading" @click="endRecord">
              停止录音
            </el-button>
          </el-col>
        </el-row>

        <div class="result" v-if="recordValue">
          识别结果: {{ recordValue }}
        </div>
      </div>
      ...
      <div class="demo-block">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-button type="success" :disabled="recordLoading" @click="beginCustomRecord">
              开始录音
            </el-button>
          </el-col>
          <el-col :span="12">
            <el-button type="danger" :disabled="!recordLoading" @click="endCustomRecord">
              停止录音
            </el-button>
          </el-col>
        </el-row>

        <el-card class="record-status" style="margin-top: 20px">
          <div slot="header">
            <span>识别状态</span>
          </div>
          <div v-if="recordLoading" class="recording">
            <i class="el-icon-microphone" style="color: #f56c6c"></i>
            正在录音...
          </div>
          <div v-if="customRecordValue" class="record-result">
      ...
      <div class="demo-block">
        ...
        <el-button type="primary" :loading="errorRecordLoading" @click="handleErrorRecord">
      ...
      <div class="demo-block">
        ...
        <div class="chat-container">
          <el-x-bubble content="你好，请点击下方按钮开始语音输入" placement="start" :avatarSize="40"
            avatar="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png" />
          <el-x-bubble v-if="chatRecordValue" :content="chatRecordValue" placement="end" :avatarSize="40"
            avatar="https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png" class="mt-10" />
        </div>
        <div class="demo-controls">
          <el-row :gutter="20">
            ...
            <el-col :span="6">
              <el-button type="primary" :loading="chatRecordLoading" @click="handleChatRecord"
